...
<script>
import { listData, delData, addData, bindYJ, updateData } from "@/api/basicinfo/detectionArea";
...
export default {
  ...
  data() {
    return {
      ...
      modalItems: [
        {type: 'input', label: '名称', paramName: 'name'},
        {type: 'input', label: '区域类型', paramName: 'type'},
        {type: 'select', label: '是否重点区域', paramName: 'isImportance', options: isImportanceList, labelWidth: '110px'},
